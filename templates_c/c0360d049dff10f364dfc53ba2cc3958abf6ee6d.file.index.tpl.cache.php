...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_4e650dba35a1c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4e650dba35a1c')) {function content_4e650dba35a1c($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/Applications/MAMP/htdocs/cms/libs/plugins/modifier.capitalize.php';
if (!is_callable('smarty_modifier_date_format')) include '/Applications/MAMP/htdocs/cms/libs/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include '/Applications/MAMP/htdocs/cms/libs/plugins/function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include '/Applications/MAMP/htdocs/cms/libs/plugins/function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include '/Applications/MAMP/htdocs/cms/libs/plugins/function.html_options.php';
?><?php echo '/*%%SmartyNocache:13839199294e650dba192f97-38708957%%*/<?php $_smarty = $_smarty_tpl->smarty; if (!is_callable(\'smarty_modifier_capitalize\')) include \'/Applications/MAMP/htdocs/cms/libs/plugins/modifier.capitalize.php\';
if (!is_callable(\'smarty_modifier_date_format\')) include \'/Applications/MAMP/htdocs/cms/libs/plugins/modifier.date_format.php\';
?>/*/%%SmartyNocache:13839199294e650dba192f97-38708957%%*/';?>
<?php echo $_smarty_tpl->getSubTemplate ("headinclude.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('title'=>'foo'), 0);?>

<?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('title'=>'foo'), 0);?>



<?php echo '/*%%SmartyNocache:13839199294e650dba192f97-38708957%%*/<?php if ($_smarty_tpl->tpl_vars[\'loggedin\']->value==true){?>/*/%%SmartyNocache:13839199294e650dba192f97-38708957%%*/';?>Herzlich Wilkommen, <?php echo '/*%%SmartyNocache:13839199294e650dba192f97-38708957%%*/<?php echo $_smarty_tpl->tpl_vars[\'username\']->value;?>
/*/%%SmartyNocache:13839199294e650dba192f97-38708957%%*/';?>.<?php echo '/*%%SmartyNocache:13839199294e650dba192f97-38708957%%*/<?php }else{ ?>/*/%%SmartyNocache:13839199294e650dba192f97-38708957%%*/';?>Hallo Gast<?php echo '/*%%SmartyNocache:13839199294e650dba192f97-38708957%%*/<?php }?>/*/%%SmartyNocache:13839199294e650dba192f97-38708957%%*/';?><br />
<br />
...
The value of {$Name} is <b><?php echo '/*%%SmartyNocache:13839199294e650dba192f97-38708957%%*/<?php echo $_smarty_tpl->tpl_vars[\'Name\']->value;?>
/*/%%SmartyNocache:13839199294e650dba192f97-38708957%%*/';?></b>

Test: <?php if ($_smarty_tpl->tpl_vars['test']->value==false){?>FALSCH<?php }else{ ?>TRVE!<?php }?>

variable modifier example of {$Name|upper}

<b><?php echo '/*%%SmartyNocache:13839199294e650dba192f97-38708957%%*/<?php echo mb_strtoupper($_smarty_tpl->tpl_vars[\'Name\']->value,SMARTY_RESOURCE_CHAR_SET);?>
/*/%%SmartyNocache:13839199294e650dba192f97-38708957%%*/';?></b>
